User.create!([
  {email: "mlandaetasanchez@gmail.com", password: "plopplop", name: nil, address: nil, country: nil, customer_id: 1},
  {email: "mariolopezlandes@gmail.com", password: "plopplop", name: nil, address: nil, country: nil, customer_id: 1}
])
Attendance.create!([
